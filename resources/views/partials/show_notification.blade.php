                        ...
                        <tbody>
                            @foreach ($notifications as $i => $notification)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ $notification->data['data'] == 'View sales' ? url("/mark-as-read/sales", $notification->id ) : url("/mark-as-read/quotes", $notification->id ) }}" class="btn  btn-primary" data-id="{{ $notification->id }}"><i
