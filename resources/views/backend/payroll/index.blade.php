            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @can('Payroll Create')
                            <a href="{{ url('payroll/create') }}" class="btn  btn-outline-primary"> <i
                                    class=" fas fa-plus"></i>
                                {{ __('app.btn_add') }}</a>
                        @endcan
                    </div>
                        ...
                        <tbody>
                            @foreach ($payroll as $i => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('payroll', $item->id) }}" class="btn  btn-warning"><i
                                                class="fas fa-file-invoice text-white"></i></a>
                                        @can('Payroll Delete')
                                            <button class="btn  btn-danger deletePayroll" data-toggle="modal"
