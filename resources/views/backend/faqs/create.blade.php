...
@section('title-page', __('app.create_faqs'))
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{ __('app.create_faqs') }}</h3>
                ...
                <div class="card-body">
                    <form id="quickForm" action="{{ url('faqs') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="faqs_km" class="form-control summernote" rows="10">{{ old('faqs_en') }}</textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="faqs_en" class="form-control summernote" rows="10">{{ old('faqs_en') }}</textarea>
