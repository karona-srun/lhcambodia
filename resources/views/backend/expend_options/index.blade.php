            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/expend-options-exportexcel') }}" class="btn  btn-outline-primary"> <i class=" fas fa-download"></i>
                            ...
                            @foreach ($expends as $i => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn  btn-primary editExpend" data-toggle="modal"
                                            data-target="#modal-default-view" data-id="{{ $item->id }}"><i
                                                class="far fa-eye"></i></button>
                                        @endcan
                                        @can('Option Expend Edit')
                                        <button class="btn  btn-warning editExpend" data-toggle="modal"
