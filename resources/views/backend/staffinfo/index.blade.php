            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/staff-exportexcel') }}" class="btn btn-outline-primary class=" fas fa-download"></i>
                            {{ __('app.btn_download') }}</a>
                        @can('Staff List')
                        <a href="{{ url('staff-info/create') }}" class="btn btn-primary class=" fas fa-plus"></i>
                            {{ __('app.btn_add') }}</a>
                        @endcan
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($staffInfo as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('Staff Edit')
                                        <a href="{{ url('staff-info',$item->id) }}" class="btn rimary"><i
                                                class="far fa-eye"></i></a>
                                        @endcan
                                        @can('Staff Delete')
                                        <button class="btn anger deleteStaff" data-toggle="modal"
