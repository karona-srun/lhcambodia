                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="btn-group">
                                ...
                                <button type="submit" class="btn  btn-outline-primary exportexcel"> <i
                                        class=" fas fa-download"></i>
                                    {{ __('app.btn_download') }}</button>

                                @can('Attandance Create')
                                    {{-- <a href="{{ url('attendances/create') }}" class="btn  ml-2 btn-primary"> <i
                                            class=" fas fa-plus"></i>
                                        {{ __('app.btn_add') }}</a> --}}
                                    <button type="button" class="btn  ml-2 btn-primary createAttendance"
                    ...
                    <table id="datatable" class="table table-bordered table-striped" width="100%">
                        ...
                        @foreach ($attendances as $i => $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('Attandance Edit')
                                            <button class="btn  btn-warning editAttendance" data-toggle="modal"
                                                data-target="#modal-default-edit" data-id="{{ $item->id }}"><i
                                                    class="far fa-edit"></i></button>
                                        @endcan
                                        @can('Attandance Delete')
                                            <button class="btn  btn-danger deleteAttendance" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <form action="{{ url('/attendances') }}" method="post">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit"
                            class="btn  pl-3 pr-3 btn-outline-primary"><i class="fas fa-save"></i> {{ __('app.btn_save') }}</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form class="formDelete" action="foo" method="post">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn  btn-danger"
                            data-dismiss="modal"><i class="fas fa-window-close"></i> {{ __('app.btn_close') }}</button>
                        <button type="submit" class="btn  btn-primary"><i class="fas fa-trash"></i> {{ __('app.btn_delete') }}</button>
                    </div>
                </form>
            </div>
        </div>
