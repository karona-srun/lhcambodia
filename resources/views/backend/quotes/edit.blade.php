                ...
                <form action="{{ route('quotes.update', $quote->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <button type="submit" class="btn utline-primary"> <i class=" fas fa-save"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <button class="btn ight mb-2" id="addBtn" type="button">
                                    ...
                                    <tbody id="tbody">
                                        @foreach ($quote->quoteDetail as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-outline-danger e"><i
            ...
            $('#addBtn').on('click', function() {
                $('#tbody').append(`
                    <tr id="R${++rowIdx}">
                        ...
                        <td>
                            <button class="btn btn-outline-danger e"><i class="fas fa-minus"></i></button>
                        </td>
                    </tr>
                `);
