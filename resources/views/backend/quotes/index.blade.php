            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/quote-exportexcel') }}" class="btn  btn-outline-primary"> <i class=" fas fa-download"></i>
                            {{ __('app.btn_download') }} {{__('app.label_all')}}</a>
                        @can('Time Create')
                        <a href="{{ url('quotes/create') }}" class="btn  btn-primary"> <i class=" fas fa-plus"></i>
                            {{ __('app.btn_add') }}</a>
                        @endcan
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach($quotes as $index => $quote)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('quotes.show', $quote->id )}}" class="btn btn-primary "><i class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
