            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn  btn-primary btn-transf-product"><i class=" fas fa-save"></i> {{__('app.btn_save')}}</button>
                        <a href="{{ url('productes') }}" class="btn  btn-outline-primary"> <i
