...
@section('title-page', __('app.edit_product'))
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{ __('app.edit_product') }}</h3>
                    ...
                    <form id="quickForm" action="{{ url('productes', $product->id) }}" method="post"
                        ...
                        <div class="card-body">
                                                            ...
                                                            <div class="card hdtuto">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p class="card-text text-white">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn  btn-danger btn-delete-file confirmation float-right"
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn  btn-primary"><i class="fas fa-save"></i> {{ __('app.btn_save') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
