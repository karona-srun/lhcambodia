            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/times-exportexcel') }}" class="btn utline-primary"> <i class=" fas fa-download"></i>
                            {{ __('app.btn_download') }}</a>
                        @can('Time Create')
                        <a href="{{ url('times/create') }}" class="btn rimary"> <i class=" fas fa-plus"></i>
                            {{ __('app.btn_add') }}</a>
                        @endcan
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($times as $i => $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('Time List')
                                        <button class="btn rimary editPosition" data-toggle="modal"
                                            data-target="#modal-default-view" data-id="{{ $item->id }}"><i
                                                class="far fa-eye"></i></button>
                                        @endcan
                                        @can('Time Edit')
                                        <button class="btn arning editPosition" data-toggle="modal"
                                            data-target="#modal-default-edit" data-id="{{ $item->id }}"><i
                                                class="far fa-edit"></i></button>
                                        @endcan
                                        @can('Time Dalete')
                                        <button class="btn anger deletePosition" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn anger" data-dismiss="modal">{{ __('app.btn_close') }}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="quickForm" action="{{ url('/update-times') }}" method="post">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn anger"
                            data-dismiss="modal">{{ __('app.btn_close') }}</button>
                        <button type="submit" class="btn rimary updatePosition">{{ __('app.btn_save') }}</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                <form class="formDelete" action="foo" method="post">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn anger"
                            data-dismiss="modal">{{ __('app.btn_close') }}</button>
                        <button type="submit" class="btn rimary">{{ __('app.btn_delete') }}</button>
                    </div>
                </form>
            </div>
        </div>
