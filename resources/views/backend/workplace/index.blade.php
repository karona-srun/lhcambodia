            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/workplace-exportexcel') }}" class="btn  btn-outline-primary"> <i class=" fas fa-download"></i>
                        ...
                        <tbody>
                            @foreach ($workplace as $i => $item)
                                <tr>
                                    ...
                                    <td>
                                        @can('WorkPlace List')
                                        <button class="btn  btn-primary editPosition" data-toggle="modal"
                                            data-target="#modal-default-view" data-id="{{ $item->id }}"><i
                                                class="far fa-eye"></i></button>
                                        @endcan
                                        @can('WorkPlace Edit')
                                        <button class="btn  btn-warning editPosition" data-toggle="modal"
                                            data-target="#modal-default-edit" data-id="{{ $item->id }}"><i
                                                class="far fa-edit"></i></button>
                                        @endcan
                                        @can('WorkPlace Delete')
                                        <button class="btn  btn-danger deletePosition" data-toggle="modal"
