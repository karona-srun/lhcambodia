                                        ...
                                        <tbody>
                                            @foreach ($addCart as $i => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->note }}</td>
                                                    <td>
                                                        <button class="btn anger deleteAddCart"
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ url('add-cart') }}" method="post">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit"
                                                class="btn rimary btn-submit">{{ __('app.btn_accepted') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <form class="formDelete" action="foo" method="post">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn anger"
                                                data-dismiss="modal">{{ __('app.btn_close') }}</button>
                                            <button type="submit"
                                                class="btn rimary">{{ __('app.btn_delete') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <form action="{{ url('add-cart') }}" method="post">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn anger"
                                                data-dismiss="modal">{{ __('app.btn_close') }}</button>
                                            <button type="submit"
                                                class="btn btn-primary ubmit">{{ __('app.btn_accepted') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
