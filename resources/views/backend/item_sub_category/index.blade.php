...
@section('title-page', __('app.item_sub_category'))
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{ __('app.item_sub_category_list') }}</h3>
                    <div class="card-tools">
                        ...
                        @can('Create Item Sub Category')
                            <a href="{{ url('item-sub-category/create') }}" class="btn btn-primary"> <i class=" fas fa-plus"></i>
                                {{ __('app.btn_add') }}</a>
                        @endcan
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('Edit Item Sub Category')
                                            <a href="{{ route('item-sub-category.edit', $item->id) }}"
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(".deleteProductCategory").click(function() {
                var id = $(this).data("id");
                $('.formDelete').attr('action', 'item-sub-category/' + id);
            });
