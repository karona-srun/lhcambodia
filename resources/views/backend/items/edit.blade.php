    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form id="quickForm" action="{{ url('itemes', $item->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="text-center mb-2 container">
                                        <img id="blah"
                                            src="{{ asset($item->photo == '' ? 'images/product_image.png' : url('items/', $item->photo)) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>{{ __('app.item_category') }} <small
                                                ...
                                                <select name="item_category" id="item_category"
                                                    ...
                                                    @foreach ($itemCategory as $g)
                                                        <option value="{{ $g->id }}"
                                                            {{ $g->id == $item->item_category_id ? 'selected' : '' }}>
                                                            {{ $g->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>{{ __('app.item_sub_category') }} <small
                                                        class="text-red">*</small></label>
                                                <select name="item_sub_category" id="item_sub_group"
                                                    class="select2 form-control">
                                                    <option value="">{{ __('app.table_choose') }}</option>
                                                    @foreach ($itemSubCategory as $isg)
                                                        <option value="{{ $isg->id }}"
                                                            {{ $isg->id == $item->item_sub_category_id ? 'selected' : '' }}>
                                                            {{ $isg->name }}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('item_group'))
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" name="buying_price"
                                                    class="form-control" value="{{ $item->buying_price }}">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="buying_date" class="form-control"
                                                    value="{{ Carbon\Carbon::parse($item->buying_date)->format('Y-m-d') }}">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select name="condition" id="status" class="select2s form-control">
                                                    <option value="0" {{ $item->condition == 0 ? 'selected' : '' }}>
                                                        {{ __('app.label_old_item') }}</option>
                                                    <option value="1" {{ $item->condition == 1 ? 'selected' : '' }}>
                                                        {{ __('app.label_new_item') }}</option>
                                                    <option value="2" {{ $item->condition == 2 ? 'selected' : '' }}>
                                                        {{ __('app.label_second_hand_item') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
