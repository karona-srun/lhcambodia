            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/income-options-exportexcel') }}" class="btn  btn-outline-primary"> <i class=" fas fa-download"></i>
                            ...
                            @foreach ($incomes as $i => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn  btn-primary editIncome" data-toggle="modal"
                                            data-target="#modal-default-view" data-id="{{ $item->id }}"><i
                                                class="far fa-eye"></i></button>
                                        @endcan
                                        @can('Option Income Edit')
                                        <button class="btn  btn-warning editIncome" data-toggle="modal"
                                            data-target="#modal-default-edit" data-id="{{ $item->id }}"><i
                                                class="far fa-edit"></i></button>
                                        @endcan
                                        @can('Option Income Delete')
                                        <button class="btn  btn-danger deleteIncome" data-toggle="modal"
