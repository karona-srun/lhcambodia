...
@section('title-page', __('app.create_item_category'))
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{ __('app.create_item_category') }}</h3>
                ...
                <div class="card-body">
                    <form id="quickForm" action="{{ url('item-category') }}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
