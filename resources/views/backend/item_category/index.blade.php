...
@section('title-page', __('app.item_category'))
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{ __('app.item_category_list') }}</h3>
                    <div class="card-tools">
                        ...
                        @can('Create Item Category')
                            <a href="{{ url('item-category/create') }}" class="btn btn-primary"> <i class=" fas fa-plus"></i>
                                {{ __('app.btn_add') }}</a>
                        @endcan
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(".deleteProductCategory").click(function() {
                var id = $(this).data("id");
                $('.formDelete').attr('action', 'item-category/' + id);
            });
