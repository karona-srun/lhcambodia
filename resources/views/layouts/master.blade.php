                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right div-with-scroll">
                        @foreach (auth()->user()->unreadNotifications as $notification)
                            <a href="{{ $notification->data['data'] == 'View sales' ? url('/mark-as-read/sales', $notification->id) : url('/mark-as-read/quotes', $notification->id) }}"
                                class="dropdown-item">
                                <div class="media">
                                    <img src="{{ asset('images/avatar.png') }}" alt="User Avatar"
                                        class="img-size-32 mr-3 img-circle">
                                    <div class="media-body">
                                        <h3 class="dropdown-item-title text-sm mt-1">
                                            <i
                                                class="{{ $notification->data['data'] == 'View sales' ? 'nav-icon fas fa-shopping-cart' : 'nav-icon fas fa-hand-holding-usd' }}"></i>
                                            {{ __('app.label_received_notification') }} <br>
                                            {{ $notification->data['name'] }}
                                            {{ __('app.label_request') }}<strong>{{ $notification->data['data'] == 'View sales' ? __('app.sales') : __('app.quote') }}</strong>{{ __('app.label_to_you') }}
                                            <span class="float-right text-sm"><i class="far fa-clock"></i>
                                                {{ $notification->created_at->diffForHumans() }}</span>
                                        </h3>
                                    </div>
                                ...
                                @if (auth()->user()->unreadNotifications->count() != 0)
                                    <div class="col-sm-12">
                                        <a href="{{ route('mark-as-read') }}"
                                            class="text-primary dropdown-item">{{ __('app.label_mask_all_as_Read') }}</a>
                                    </div>
                                    <div class="col-sm-12">
                                        <a href="{{ url('notification') }}"
                                            class="text-primary dropdown-item">{{ __('app.label_all_notifications') }}</a>
                                    </div>
                                @else
                                    <div class="col-sm-12 col-md-12">
                                        <a href="{{ route('mark-as-read') }}"
                                            class="text-muted dropdown-item">{{ __('app.lable_no_notification') }}</a>
                                    </div>
                                @endif
                            @endif
                        </div>
                ...
                <nav>
                    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent mb-5" data-widget="treeview"
                        ...
                        @if (Auth::user()->can('Staff List') ||
                            ...
                            <li
                                class="nav-item {{ Request::is('staff-info*') || Request::is('positions*') || Request::is('department*') || Request::is('workplace*') || Request::is('base-salary*') || Request::is('payroll*') ? 'menu-is-opening menu-open' : null }} ">
                                <a href="#"
                                    class="nav-link {{ Request::is('staff-info*') || Request::is('positions*') || Request::is('department*') || Request::is('workplace*') || Request::is('base-salary*') || Request::is('payroll*') ? 'active' : null }} ">
                        ...
                        @if (Auth::user()->can('Product Category List') ||
                            ...
                            <li
                                class="nav-item {{ Request::is('product-category*') || Request::is('productes*') || Request::is('product-sub-category*') || Request::is('import-product*') || Request::is('sales-order*') || Request::is('purchase-order*') ? 'menu-is-opening menu-open' : null }} ">
                                <a href="#"
                                    class="nav-link {{ Request::is('product-category*') || Request::is('productes*') || Request::is('import-product*') || Request::is('product-sub-category*') || Request::is('sales-order*') ? 'active' : null }} ">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('sales-order') }}"
                                            class="nav-link {{ Request::is('sales-order*') ? 'active' : null }}">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('purchase-order') }}"
                                            class="nav-link {{ Request::is('purchase-order*') ? 'active' : null }}">
                                            <i class="nav-icon fas fa-shopping-bag"></i>
                                            <p>
                        ...
                        @endif
                        @if (Auth::user()->can('Item Category List') ||
                                Auth::user()->can('Item Sub Category List') ||
                                Auth::user()->can('Item List') ||
                                Auth::user()->can('Item Adjustment List'))
                            <li
                                class="nav-item {{ Request::is('item-category*') || Request::is('item-sub-category*') || Request::is('itemes*') || Request::is('adjustment*') ? 'menu-is-opening menu-open' : null }} ">
                                <a href="{{ url('/#') }}"
                                    class="nav-link {{ Request::is('item-category*') || Request::is('item-sub-category*') || Request::is('itemes*') || Request::is('adjustment*') ? 'active' : null }}">
                                    <i class="fas fa-warehouse nav-icon"></i>
                                    <p>{{ __('app.inventory') }}</p>
                                    <i class="fas fa-angle-left right"></i>
                                </a>
                                <ul class="nav nav-treeview">
                                    @can('Item Category List')
                                        <li class="nav-item">
                                            <a href="{{ url('/item-category') }}"
                                                class="nav-link {{ Request::is('item-category*') ? 'active' : null }} ">
                                                <i class="fas fa-boxes nav-icon"></i>
                                                <p>{{ __('app.item_category') }}</p>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('Item Sub Category List')
                                        <li class="nav-item">
                                            <a href="{{ url('/item-sub-category') }}"
                                                class="nav-link {{ Request::is('item-sub-category*') ? 'active' : null }} ">
                                                <i class="fas fa-boxes nav-icon"></i>
                                                <p>{{ __('app.item_sub_category') }}</p>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('Item List')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('.customer').change(function(event) {
                ...
                var phone = $('option:selected', this).attr('data-customer-phone');
