...
class ProductController extends Controller
{
    ...
    {
        $product_category = ProductCategory::orderBy('name', 'desc')->get();
        $sub_category = ProductSubCategoory::orderBy('name', 'desc')->get();
        return view('backend.products.create', compact('product_category','sub_category'));
    }
    ...
    public function edit($id)
    {
        ...
        $sub_category = ProductSubCategoory::orderBy('name', 'desc')->get();
        $attachments = Attachment::where(['type_id' => $id, 'type' => 'product'])->get();
        return view('backend.products.edit', compact('product', 'product_category', 'attachments','sub_category'));
    }
