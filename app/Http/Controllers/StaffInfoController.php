...
class StaffInfoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.staffinfo.create', compact('times','position','depart','workPlace','baseSalary'));
    }
    ...
    public function show($id)
    {
        ...
        $depart = Department::orderBy('name','desc')->get();
        return view('backend.staffinfo.show', compact('attachments','times','depart','staffInfo','position','workPlace','baseSalary'));
    }
